...
describe('EventEmitter', function tests() {
    ...
    describe('EventEmitter#emit', function () {
      ...
      it('emit multiple arguments ok addListener', function (done) {
        ...
        e.addListener('foo', function (bar, a1: number, a2: number, a3: number, a4: number, a5: number, a6: number, a7: number, a8: number, a9: number, a10: number) {
          assume(bar).equals('bar');
          assume(a1).equals(1);
          assume(a2).equals(2);
          assume(a3).equals(3);
      ...
      it('emit multiple arguments ok once', function (done) {
        ...
        e.once('foo', function (bar, a1: number, a2: number, a3: number, a4: number, a5: number, a6: number, a7: number, a8: number, a9: number, a10: number) {
          assume(bar).equals('bar');
          assume(a1).equals(1);
          assume(a2).equals(2);
          assume(a3).equals(3);
