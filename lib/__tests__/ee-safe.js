...
describe('EventEmitter', function tests() {
    ...
    it('inherits when used with `require("util").inherits`', function () {
        function Beast() {
            ee_safe_1.EventEmitter.call(this);
        }
        require('util').inherits(Beast, ee_safe_1.EventEmitter);
        var moop = new Beast(), meap = new Beast();
        (0, assume_1.default)(moop).is.instanceOf(Beast);
        (0, assume_1.default)(moop).is.instanceOf(ee_safe_1.EventEmitter);
        moop.listeners();
        meap.listeners();
    ...
    if ('undefined' !== typeof Symbol)
        it('works with ES6 symbols', function (next) {
            var e = new ee_safe_1.EventEmitter(), event = Symbol('cows'), unknown = Symbol('moo');
    ...
    describe('EventEmitter#emit', function () {
        ...
        it('emits with context, multiple arguments (force apply) addListenerBound', function (done) {
            var context = { bar: 'baz' }, e = new ee_safe_1.EventEmitter();
        ...
        it('emits with context, multiple arguments (force apply) addListener', function (done) {
            var context = { bar: 'baz' }, e = new ee_safe_1.EventEmitter();
            e.addListener('foo2', function (bar) {
                (0, assume_1.default)(bar).equals('bar2');
                (0, assume_1.default)(this).equals(context);
                done();
            }.bind(context)).emit('foo2', 'bar2', 1, 2, 3, 4, 5, 6, 7, 8, 9, 0);
        });
        it('emits once with context, multiple arguments (force apply)', function (done) {
            var context = { bar: 'baz' }, e = new ee_safe_1.EventEmitter();
        ...
        it('emit multiple arguments ok addListener', function (done) {
            var context = { bar: 'baz' }, e = new ee_safe_1.EventEmitter();
            e.addListener('foo', function (bar, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
                (0, assume_1.default)(bar).equals('bar');
                (0, assume_1.default)(a1).equals(1);
                (0, assume_1.default)(a2).equals(2);
                (0, assume_1.default)(a3).equals(3);
                (0, assume_1.default)(a4).equals(4);
                (0, assume_1.default)(a5).equals(5);
                (0, assume_1.default)(a6).equals(6);
                (0, assume_1.default)(a7).equals(7);
                (0, assume_1.default)(a8).equals(8);
                (0, assume_1.default)(a9).equals(9);
                (0, assume_1.default)(a10).equals(0);
                done();
            }.bind(context)).emit('foo', 'bar', 1, 2, 3, 4, 5, 6, 7, 8, 9, 0);
        });
        it('emit multiple arguments ok once', function (done) {
            var context = { bar: 'baz' }, e = new ee_safe_1.EventEmitter();
            e.once('foo', function (bar, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
                (0, assume_1.default)(bar).equals('bar');
                (0, assume_1.default)(a1).equals(1);
                (0, assume_1.default)(a2).equals(2);
                (0, assume_1.default)(a3).equals(3);
        ...
        it('emits with different contexts', function () {
            var e = new ee_safe_1.EventEmitter(), pattern = '';
            function writer() {
                pattern += this;
            }
        ...
        it('should return true when there are events to emit', function () {
            var e = new ee_safe_1.EventEmitter(), called = 0;
            e.on('foo', function () {
                called++;
            });
    ...
    describe('EventEmitter#once', function () {
        it('only emits it once', function () {
            var e = new ee_safe_1.EventEmitter(), calls = 0;
            e.once('foo', function () {
                calls++;
            });
            e.emit('foo');
        ...
        it('only emits once for multiple events', function () {
            var e = new ee_safe_1.EventEmitter(), multi = 0, foo = 0, bar = 0;
            e.once('foo', function () {
                foo++;
            });
            e.once('foo', function () {
        ...
        it('only emits once with context', function (done) {
            var context = { foo: 'bar' }, e = new ee_safe_1.EventEmitter();
            e.once('foo', function (bar) {
                (0, assume_1.default)(this).equals(context);
                (0, assume_1.default)(bar).equals('bar');
                done();
    ...
    describe('EventEmitter#eventNames', function () {
        ...
        it('returns an array listing the events that have listeners', function () {
            var e = new ee_safe_1.EventEmitter(), original;
            function bar() { }
        ...
        if ('undefined' !== typeof Symbol)
            it('includes ES6 symbols', function () {
                var e = new ee_safe_1.EventEmitter(), s = Symbol('s');
                function foo() { }
                e.on('foo', foo);
                e.on(s, function () { });
...
//# sourceMappingURL=ee-safe.js.map